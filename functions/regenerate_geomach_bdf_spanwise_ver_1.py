...
#                break
    ...
    for iwing in range(0,len(aircraft.main_wing)):
        ...
        for ielem in range(0,len(wing.upper.fea_element_nos)):
            local_pid = min(int(math.floor(float(elemlist[ielem].centroid[2] - wing_root_z)/float(section_span))),wing.upper.required_no_of_elements)
            if(local_pid < 0):
                local_pid = 0
        
            elemlist[ielem].pid = local_dv_value + local_pid
            #elemlist[ielem].pid = local_dv_value + min(int(math.floor(float(elemlist[ielem].centroid[2] - wing_root_z)/float(section_span))),wing.upper.required_no_of_elements)
        ...
        for ielem in range(0,len(wing.lower.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[2] - wing_root_z)/section_span)),wing.lower.required_no_of_elements)                  
        ...
        for ielem in range(0,len(wing.tip.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value #+ min(int(math.floor((elemlist[ielem].centroid[2] - wing_root_z)/section_span)),wing.lower.dv_value)                  
        for i in range(0,1):
        ...
        for ielem in range(0,len(wing.spars.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[2] - wing_root_z)/section_span)),wing.spars.required_no_of_elements)                  
        ...
        for ielem in range(0,len(wing.ribs.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[2] - wing_root_z)/section_span)),wing.ribs.required_no_of_elements)                            
    ...
    for ifus in range(0,len(aircraft.fuselage)):
        ...
        for ielem in range(0,len(fuse.top.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.top.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.bottom.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.bottom.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.left.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.left.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.right.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.right.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.front.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value #+ min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.right.dv_value)                  
        for i in range(0,1):
        ...
        for ielem in range(0,len(fuse.r1.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.r1.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.r2.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.r2.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.r3.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.r3.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.r4.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.r4.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.l1.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.l1.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.l2.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.l2.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.l3.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.l3.required_no_of_elements)                  
        ...
        for ielem in range(0,len(fuse.l4.fea_element_nos)):
            elemlist[ielem].pid = local_dv_value + min(int(math.floor((elemlist[ielem].centroid[0] - fus_root_z)/section_span)),fus.l4.required_no_of_elements)                  
