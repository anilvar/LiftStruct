...
class aircraft:
	...
	if((vehicle.fea_type == "Strut_Braced") or (vehicle.fea_type == "Strut_Braced2")):
        ...
        for i in range(0,no_of_fuselages):
            ...
            dv_breakdown.fuselages[i].front.required_no_of_elements = fuselages[i].structural_dv
            dv_breakdown.fuselages[i].rear.required_no_of_elements = fuselages[i].structural_dv
        ...
        for i in range(0,no_of_wings):
            ...
            dv_breakdown.wings[i].tip.required_no_of_elements = main_wing[i].structural_dv
...
#        plt.savefig('constraint_nasa_orieo.png')
	...
	strut_wing_index = self.strut_wing
        ...
        strut_position_tip = np.array(self.main_wing[0].root_origin) + main_wing_direction*strut_location_wing*main_wing_span*1.00 - np.array([0.0,0.5,0.0])
